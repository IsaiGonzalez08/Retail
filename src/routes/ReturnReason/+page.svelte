...
<div
	class="flex flex-col w-full h-screen galaxy-z:px-1 custom:px-5 custom2:px-6"
...
>
	<div class="galaxy-z:px-2 custom:px-0">
		...
		<div class="flex gap-2 justify-center w-full mt-8">
			...
			>
				<img
					src={selections[currentIndex] === 1 ? '/FullScreen.svg' : '/size.svg'}
					alt="size-icon"
				/>
				Size
			</button>
			...
			>
				<img
					src={selections[currentIndex] === 2 ? '/Target.svg' : '/damage.svg'}
					alt="damage-icon"
				/>
				Damage
			</button>
		...
		<div class="flex mt-[8px] gap-2 justify-center w-full">
			...
			>
				<img
					src={selections[currentIndex] === 3 ? '/BarChart.svg' : '/quality.svg'}
					alt="quality-icon"
				/>
				Quality
			</button>
			...
			>
				<img
					src={selections[currentIndex] === 4 ? '/change.svg' : '/Sad.svg'}
					alt="change-mind-icon"
				/>
				Change Mind
			</button>
		</div>
	...
	<div class="flex flex-col items-center">
		...
		<button
			on:click={openModal}
			class="mt-[20px] w-[54px] h-[20px] font-manrope font-bold text-[#000101] border-b-[1px] border-[#000101]"
		>
			Cancel
		</button>
	</div>
