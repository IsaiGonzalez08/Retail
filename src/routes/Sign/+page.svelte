...
<div class="flex flex-col w-full h-screen galaxy-z:px-1 custom:px-5 custom2:px-6">
	<div class="galaxy-z:px-2 custom:px-0 basis-3/4">
	...
	<div class="flex flex-col justify-start items-center gap-5 galaxy-z:px-2 custom:px-0 basis-1/4">
		<button
